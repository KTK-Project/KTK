...
std::shared_ptr<Card> Event_Judge::getM_judgeCard() {
	return this->m_judgeCard;
}

void Event_Judge::setM_judgeCard(std::shared_ptr<Card> m_judgeCard) {
	this->m_judgeCard = m_judgeCard;
}

std::function<bool (std::shared_ptr<Card>)> Event_Judge::getM_judgeCheck() {
	return this->m_judgeCheck;
}

void Event_Judge::setM_judgeCheck(std::function<bool (std::shared_ptr<Card>)> m_judgeCheck) {
