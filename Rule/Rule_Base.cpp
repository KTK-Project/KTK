...
void Rule_Base::setPlayer(const std::shared_ptr<Player> player) const {
...
bool Rule_Base::canAsCandidate(const ECardName cardName) const {
	// TODO - implement Rule_Character::canAsCandidate
	throw "Not yet implemented";
}

void Rule_Base::asCardGoal(const ECardName cardName) const {
	//大乔流离应该重新实现这个函数
