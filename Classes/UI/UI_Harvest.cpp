...
bool UI_Harvest::initWithCards(const std::vector<std::shared_ptr<Card>> & cards) {
...
void UI_Harvest::chosedCard(const std::shared_ptr<Player> & player, const std::shared_ptr<Card> & card) {
