...
bool UI_GuanXing::initWithCards(const std::vector<std::shared_ptr<Card>> & topCards) {
	...
	//对每一个std::shared_ptr<UI_Card>设置事件处理，按下的时候跟着移动，放下的时候计算到各个点的距离，设置动作，
	//并于动作结束时，继续接受触摸事件
	// TODO - implement UI_GuanXing::initWithCards
	throw "Not yet implemented";
}

const std::vector<std::shared_ptr<UI_Card>> & UI_GuanXing::getTopCards() {
	// TODO - implement UI_GuanXing::getTopCards
	throw "Not yet implemented";
}

const std::vector<std::shared_ptr<UI_Card>> & UI_GuanXing::getBottonCards() {
